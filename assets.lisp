...
(defparameter *button-specs*
  `((:dozer "dozer-btn.png" 34 2 button-tile '() "Bulldoze (D)" 1)
    (:wire "wire-btn.png" 34 2 button-tile '() "Power Lines (W)" 5)
    (:garden "garden-btn.png" 34 2 button-tile '() "Park (G)" 10)
    (:residential "residential-btn.png" 50 2 button-tile '() "Residential (H)" 100)
    (:commercial "commercial-btn.png" 50 2 button-tile '() "Commercial (C)" 100)
    (:industrial "industrial-btn.png" 50 2 button-tile '() "Industrial (I)" 100)
    (:police-department "police-department-btn.png" 34 2 button-tile '() "Police Department (P)" 500)
    (:fire-department "fire-department-btn.png" 34 2 button-tile '() "Fire Department (F)" 500)
    (:nuclear "nuclear-btn.png" 42 2 button-tile '(()) "Nuclear Plant (N)" 5000)))
